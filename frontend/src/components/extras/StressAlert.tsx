...
import { Coffee, X, Activity, AlertTriangle } from 'lucide-react';
...
export function StressAlert({ isOpen, onClose, onGoToShop }: StressAlertProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative z-10 w-[95vw] sm:max-w-xl md:max-w-2xl lg:max-w-4xl overflow-hidden rounded-xl border border-red-500/30 bg-[#050505] shadow-[0_0_50px_-10px_rgba(220,38,38,0.5)]"
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800 bg-gray-900/50">
              ...
              <div className="text-[9px] font-mono text-red-400 uppercase tracking-widest flex items-center gap-2">
            ...
            <div className="p-5 relative">
              ...
              <div className="flex flex-col items-center text-center gap-4 mb-5">
                <div className="relative">
                  <div className="w-16 h-16 rounded-xl bg-red-950 border border-red-500/30 flex items-center justify-center shadow-[0_0_15px_rgba(220,38,38,0.2)]">
                ...
                <div className="text-md font-bold text-white mb-2 capitalize tracking-tight leading-tight">
                    <h5>Do quests in other zones or grab some instant buffs from Cafetaria</h5>   
                </div>
              </div>
              ...
              <div className="bg-gray-900/40 rounded-lg p-3 border border-gray-800 mb-4">
                <div className="flex justify-between text-[10px] font-mono text-gray-500 mb-2">
                  <span className="flex items-center gap-1">💥 STRESS BAR</span>
                  <span className="text-red-500 animate-pulse font-bold">100%</span>
                </div>
              ...
              {/* Stats List
              <div className="space-y-2 mb-6 font-mono text-[11px] border-l-2 border-gray-800 pl-3 py-1">
                 <div className="flex justify-between items-center text-gray-400">
                    <span>🧠 Brain Status:</span>
                    <span className="text-red-400 animate-pulse">Overheating… 🔥</span>
                 </div>
                 <div className="flex justify-between items-center text-gray-400">
                    <span>☕ Coffee Buff:</span>
                    <span className="text-gray-600 line-through">Expired</span>
                 </div>
                 <div className="flex justify-between items-center text-gray-400">
