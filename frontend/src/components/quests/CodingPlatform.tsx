...
export const CodingPlatform: React.FC<CodingPlatformProps> = ({ className = "h-screen" }) => {
        ...
        <div className="w-1/2 md:w-7/12 flex flex-col bg-editor-bg">
          ...
          <div className="h-14 bg-[#1e293b] border-y border-slate-700 flex items-center justify-between px-4 shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <button onClick={() => actions.handleRunCode(true)} disabled={isRunning || !problem || !!backendError} className="flex items-center gap-2 px-5 py-2 rounded-lg bg-green-600 hover:bg-green-500 text-white text-sm font-semibold transition-all disabled:opacity-50">
                  <Send size={14} /> Submit
                </button>
              </div>
          </div>
