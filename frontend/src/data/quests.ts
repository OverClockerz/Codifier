...
>[] = [
  {
    title: "Code Review",
    description:
      "Review the pull requests submitted by your teammates",
    zone: "workspace",
    frequency: "daily",
  ...
  {
    title: "Dailyy Standup",
    description:
      "Participate in the daily team standup meeting",
    zone: "meeting-room",
    frequency: "daily",
  ...
  },
  {
    title: "Logic Warm-up",
    description:
      "Complete 3 quick logic puzzles to start your day fresh",
    zone: "game-lounge",
    frequency: "daily",
  ...
  },
  {
    title: "Bug Fix",
    description:
      "Identify and fix a critical bug in the production code",
    zone: "workspace",
    frequency: "daily",
    skillCategory: "technical",
    difficulty: 3,
  ...
  },
  {
    ...
    description:
      "Respond to important emails with proper grammar and tone",
    zone: "meeting-room",
    frequency: "daily",
    skillCategory: "soft-skills",
    difficulty: 2,
  ...
  },
  {
    ...
    description:
      "Integrate a third-party API into the existing codebase",
    zone: "workspace",
    frequency: "daily",
    skillCategory: "technical",
    difficulty: 3,
  ...
  },
  {
    title: "Unit Tests",
    description:
      "Write comprehensive unit tests for recent code changes",
    zone: "workspace",
    frequency: "daily",
    skillCategory: "technical",
    difficulty: 2,
  ...
  },
  {
    ...
    description:
      "Optimize slow database queries affecting performance",
    zone: "workspace",
    frequency: "daily",
    skillCategory: "technical",
    difficulty: 4,
...
// Weekly Quests
export const WEEKLY_QUESTS: Omit<
  Quest,
  "id" | "status" | "startedAt" | "completedAt"
>[] = [
  {
  ...
  },
  {
    ...
    description:
      "Prepare and deliver a presentation to the team",
    zone: "meeting-room",
    frequency: "weekly",
    skillCategory: "soft-skills",
    difficulty: 3,
  ...
  },
  {
    ...
    description:
      "Complete a typing speed and grammar assessment",
    zone: "meeting-room",
    frequency: "weekly",
    skillCategory: "soft-skills",
    difficulty: 2,
  ...
  },
  {
    ...
    description:
      "Design the system architecture for an upcoming project",
    zone: "workspace",
    frequency: "weekly",
    skillCategory: "technical",
    difficulty: 5,
...
// Monthly Quests
export const MONTHLY_QUESTS: Omit<
  Quest,
  "id" | "status" | "startedAt" | "completedAt"
>[] = [
  {
  ...
  },
  {
    ...
    description:
      "Prepare and present your quarterly performance review",
    zone: "meeting-room",
    frequency: "monthly",
    skillCategory: "soft-skills",
    difficulty: 4,
  ...
  },
  {
    ...
    description:
      "Participate in the monthly innovation challenge",
    zone: "game-lounge",
    frequency: "monthly",
    skillCategory: "critical-thinking",
    difficulty: 5,
...
export const QUEST_CHAINS: QuestChain[] = [
  {
    ...
    description:
      "A multi-zone quest chain simulating a real feature deployment workflow",
    totalExpReward: 800,
    ...
    quests: [
      {
        ...
        description:
          "Implement the core functionality for the new feature",
        zone: "workspace",
        frequency: "weekly",
        skillCategory: "technical",
        difficulty: 4,
      ...
      },
      {
        ...
        description:
          "Use logical thinking to optimize the feature performance",
        zone: "game-lounge",
        frequency: "weekly",
        skillCategory: "critical-thinking",
        difficulty: 3,
      ...
      },
      {
        ...
        description:
          "Present the completed feature to stakeholders",
        zone: "meeting-room",
        frequency: "weekly",
        skillCategory: "soft-skills",
        difficulty: 3,
...
export function generateQuest(
  ...
  const deadlineTimestamp =
    Date.now() + template.deadline * 60 * 60 * 1000;
